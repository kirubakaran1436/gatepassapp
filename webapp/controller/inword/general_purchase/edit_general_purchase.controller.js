sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.inword.general_purchase.edit_general_purchase", {
            onInit: function () {
        ...
        OnPendingQty:function(value1, value2, value3, value4, value5, value6){
            ...
            OnUpdate:function(){
                ...
                if (Purchasing_Document !== "" && Gate_Pass_Type !== ""){
                ...
                success: function(data) {
                    ...
                    that._pBusyDialog.close();
                    MessageBox.success("Document No " + General_Purchase_Document + " Updated Successfully", {
                    ...
                    that.getView().byId("General_Purchase_Document_H").setValue("");
                    ...
                    that.getView().byId("Invoice_Date_H").setValue("");
            ...
            OnUnDeleteEntireDocument:function(){
                ...
                success: function(data) {
                    console.log("Header Updated:", data);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+General_Purchase_Document+" Retrived ")        
                    oModel05.refresh(true);
                    that.getView().byId("DeleteIndicId").setVisible(false); 
                    that.getView().byId("Final_Update_Button").setVisible(true); 
                    that.getView().byId("Final_DeleteEntireDocument_Button").setVisible(true);
                ...
                error: function(error) {
                    console.error("Error updating header:", error);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+General_Purchase_Document+"Not Retrived")
                }
                });
