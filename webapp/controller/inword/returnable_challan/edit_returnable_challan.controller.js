sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.inword.returnable_challan.edit_returnable_challan", {
            onInit: function () {
            ...
            if (!this._dialog_GenPurDocNo) {
                this._dialog_GenPurDocNo = sap.ui.xmlfragment(this.getView().getId("INRtnCln_dialog"), "gatepass.view.fragments.IN_Returnable_Challan_Head", this);
        ...
        OnINRtnClnSelect : function (oEvent) {
            ...
            if (aContexts === undefined){
                ...
                var that = this;
                model0.read("/YY1_IN_RETURNABLE_CLN", {
                    filters: [filter], 
                    success: function (ODat, oRespons) {
                        ...
                        that.getView().byId("Customer_Document_No").setValue(value11.Customer_Document_No);
                        ...
                        model0.read("/YY1_IN_RETURNABLE_CLN(guid'" + SAPUIID + "')/to_Items", {
        ...
        OnPendingQty:function(value1, value2, value3, value4, value5, value6){
                    ...
                    return new Promise(function(resolve, reject) {                        
                        ...
                        var oModel01 = that.getView().getModel("YY1_IN_RETURNABLE_CLN_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2, oFilter3];

                        var CalData = 0;
                
                        oModel01.read("/YY1_ITEMS_IN_RETURNABLE_CLN", {
                            filters: oFilters,
                            success: function(oData) {
                                var aItems = oData.results;
                                for (var i = 0; i < aItems.length; i++) {
            ...
            OnGateQtyToPostEnter:function(oEvent){
                    ...
                    var that = this;
                        ...
                        var oModel02 = this.getView().getModel("YY1_IN_RETURNABLE_CLN_CDS");
                        var oModel03 = this.getView().getModel("YY1_IN_RETURNABLE_CLN_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2, oFilter3];
                
                        oModel02.read("/YY1_ITEMS_IN_RETURNABLE_CLN", {
                            filters: oFilters,
                            success: function(oData) {
                                ...
                                // -----------------------------------
                        // var oFilter00 = new sap.ui.model.Filter("Material_Document_Item", sap.ui.model.FilterOperator.EQ, PoItem);
                        // var oFilter100 = new sap.ui.model.Filter("Material_Document_No", sap.ui.model.FilterOperator.EQ, PoNo);
                        // var oFilter200 = new sap.ui.model.Filter("Material_Document_Year", sap.ui.model.FilterOperator.EQ, Vendor);
                        ...
                        oModel03.read("/YY1_ITEMS_IN_RETURNABLE_CLN", {
                            filters: oFilters,
                            success: function(oData) {
                                var aItems = oData.results;
                                for (var i = 0; i < aItems.length; i++) {
            ...
            OnUpdate:function(){
                ...
                let Customer_Document_No = this.getView().byId("Customer_Document_No").getValue();
                ...
                if (oBindingContext) {
                    ...
                    var oModel_04 = this.getView().getModel("YY1_IN_RETURNABLE_CLN_CDS");
                    oModel_04.setHeaders({
                        "X-Requested-With": "X",
                        "Content-Type": "application/json"
                    });

                    oModel_04.update("/YY1_ITEMS_IN_RETURNABLE_CLN(guid'" + SAP_UUID_I + "')", itemData, {
                ...
                var oModel05 = this.getView().getModel("YY1_IN_RETURNABLE_CLN_CDS");
                oModel05.setHeaders({
                "X-Requested-With": "X",
                "Content-Type": "application/json"
                });

                oModel05.update("/YY1_IN_RETURNABLE_CLN(guid'" + SAP_UUID_H + "')", oEntry1, {
                success: function(data) {
                    console.log("Header Updated:", data);
                    that._pBusyDialog.close();
                    oModel05.refresh(true);
                    MessageBox.success("Document No " + Returnable_Challan_H + " Updated Successfully", {
                    ...
                    that.getView().byId("Returnable_Challan_H").setValue("");
                    ...
                    that.getView().byId("Customer_Document_No").setValue("");
