sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.outword.Sales_STO.Edit_Sales_STO", {
            onInit: function () {
            ...
            if (!this._dialog_SalesSTODocNo) {
                this._dialog_SalesSTODocNo = sap.ui.xmlfragment(this.getView().getId("SalesSTODocNo_dialog"), "gatepass.view.fragments.Sales_STO", this);
                this.getView().addDependent(this._dialog_SalesSTODocNo);
            }
            this._dialog_SalesSTODocNo.open();
        },

        OnSaleSTODocNoSearch: function (oEvent) {
        ...
        OnSalesSTODocNoSelect : function (oEvent) {
            ...
            if (aContexts === undefined){
                ...
                if (aContexts && aContexts.length) {
                    ...
                    aContexts.map(function (oContext) {
                        ...
                        GatePasstype = oContext.getObject().Gate_Pass_Type;
                        return;
                    });
                ...
                model0.read("/YY1_SALES_STO", {
                    ...
                    success: function (ODat, oRespons) {
                        ...
                        model0.read("/YY1_SALES_STO(guid'" + SAPUIID + "')/to_Item", {
        ...
        OnReceivedQty:function(value1, value2,value3,value5){
            var that = this; // Store reference to 'this'
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        var oFilter = new sap.ui.model.Filter("Delivery_No_Item", sap.ui.model.FilterOperator.EQ, PoItem);
                        var oFilter1 = new sap.ui.model.Filter("Delivery_No", sap.ui.model.FilterOperator.EQ, PoNo);
                        var oFilter2 = new sap.ui.model.Filter("Status", sap.ui.model.FilterOperator.EQ, '');
                
                        var oModel = that.getView().getModel("YY1_SALES_STO_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2];

                        var CalData = 0;
                
                        oModel.read("/YY1_ITEM_SALES_STO", {
                            filters: oFilters,
                            success: function(oData) {
        ...
        OnPendingQty:function(value1,value2,value3,value4,value5){
                    ...
                    return new Promise(function(resolve, reject) {                        
                        ...
                        var oModel01 = that.getView().getModel("YY1_SALES_STO_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2];

                        var CalData = 0;
                
                        oModel01.read("/YY1_ITEM_SALES_STO", {
                            filters: oFilters,
                            success: function(oData) {
                                var aItems = oData.results;
                                for (var i = 0; i < aItems.length; i++) {
            ...
            OnGatePostEntryED:function(value1, value2,value3,value5,value7){
                    ...
                    return new Promise(function(resolve, reject) {  
                        ...
                        var oModel02 = that.getView().getModel("YY1_SALES_STO_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2];

                        var CalData = 0;
                
                        oModel02.read("/YY1_ITEM_SALES_STO", {
                                filters: oFilters,
                                success: function(oData) {
                                    var aItems = oData.results;
                                    for (var i = 0; i < aItems.length; i++) {
...
// -------------------------
            ...
            OnGateQtyToPostEnter:function(oEvent){
                ...
                var oFilter2 = new sap.ui.model.Filter("Id", sap.ui.model.FilterOperator.EQ, Id);
                    ...
                    var oModel02 = this.getView().getModel("YY1_SALES_STO_CDS");
                    var oModel03 = this.getView().getModel("YY1_SALES_STO_CDS");
                    var oFilters = [oFilter, oFilter1, oFilter2];
                    ...
                    oModel03.read("/YY1_ITEM_SALES_STO", {
                        filters: oFilters,
                        success: function(oData) {
                            var aItems = oData.results;
                            for (var i = 0; i < aItems.length; i++) {
