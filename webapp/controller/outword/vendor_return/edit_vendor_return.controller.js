sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.outword.vendor_return.edit_vendor_return", {
            onInit: function () {
            ...
            OnVenRtnNoFrag:function(oEvent){
            if (!this._dialog_GenPurDocNo) {
                this._dialog_GenPurDocNo = sap.ui.xmlfragment(this.getView().getId("OnVenRtnSelect"), "gatepass.view.fragments.Vendor_Return_Head", this);
                this.getView().addDependent(this._dialog_GenPurDocNo);
            }
            this._dialog_GenPurDocNo.open();
        },

        OnVenRtnSearch: function (oEvent) {
        ...
        OnVenRtnSelect : function (oEvent) {
            ...
            if (aContexts === undefined){
                ...
                let Dataa = this.getView().byId("Vendor_Return_H").getValue();
                if(Dataa === ""){
                ...
                if (aContexts && aContexts.length) {
                    ...
                    this.getView().byId("Vendor_Return_H").setValue(GenPurDocNo);
                ...
                var that = this;
                model0.read("/YY1_VENDOR_RETURN_OW", {
                    filters: [filter], 
                    success: function (ODat, oRespons) {
                        ...
                        model0.read("/YY1_VENDOR_RETURN_OW(guid'" + SAPUIID + "')/to_item", {
        ...
        OnReceivedQty:function(value1, value2, value3, value4, value5, value6){
            var that = this; // Store reference to 'this'
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        var oModel = that.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2, oFilter3];

                        var CalData = 0;
                
                        oModel.read("/YY1_ITEM_VENDOR_RETURN_OW", {
                            filters: oFilters,
                            success: function(oData) {
        ...
        OnPendingQty:function(value1, value2, value3, value4, value5, value6){
                    ...
                    return new Promise(function(resolve, reject) {                        
                        ...
                        var oModel01 = that.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2, oFilter3];

                        var CalData = 0;
                
                        oModel01.read("/YY1_ITEM_VENDOR_RETURN_OW", {
                            filters: oFilters,
                            success: function(oData) {
                                var aItems = oData.results;
                                for (var i = 0; i < aItems.length; i++) {
            ...
            OnGateQtyToPostEnter:function(oEvent){
                    ...
                    let Id = this.getView().byId("Vendor_Return_H").getValue();
                    ...
                    var that = this;
                        ...
                        var oModel02 = this.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                        var oModel03 = this.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                        var oFilters = [oFilter, oFilter1, oFilter2, oFilter3];
                
                        oModel02.read("/YY1_ITEM_VENDOR_RETURN_OW", {
                            filters: oFilters,
                            success: function(oData) {
                        ...
                        oModel03.read("/YY1_ITEM_VENDOR_RETURN_OW", {
                            filters: oFilters,
                            success: function(oData) {
                                var aItems = oData.results;
                                for (var i = 0; i < aItems.length; i++) {
            ...
            OnUpdate:function(){
                ...
                let Vendor_Return_H = this.getView().byId("Vendor_Return_H").getValue();
                ...
                if (Vendor_Return_H !== "" && Gate_Pass_Type !== ""){
                ...
                if (oBindingContext) {
                    ...
                    var oModel_04 = this.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                    oModel_04.setHeaders({
                        "X-Requested-With": "X",
                        "Content-Type": "application/json"
                    });

                    oModel_04.update("/YY1_ITEM_VENDOR_RETURN_OW(guid'" + SAP_UUID_I + "')", itemData, {
                ...
                var oModel05 = this.getView().getModel("YY1_VENDOR_RETURN_OW_CDS");
                oModel05.setHeaders({
                "X-Requested-With": "X",
                "Content-Type": "application/json"
                });

                oModel05.update("/YY1_VENDOR_RETURN_OW(guid'" + SAP_UUID_H + "')", oEntry1, {
                success: function(data) {
                    console.log("Header Updated:", data);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" Updated ")        
                    oModel05.refresh(true);
                    MessageBox.success("Document No " + Vendor_Return_H + " Updated Successfully", {
                        title: "Change Vendor Return",
                        id: "messageBoxId1",
                        contentWidth: "100px",
                    });                    
                    oModel05.refresh(true);
                    ...
                    that.getView().byId("Vendor_Return_H").setValue("");
                    ...
                    that.getView().byId("Material_Document_H").setValue("");
                    ...
                    that.getView().byId("Bin_Challan_No").setValue("");

                },
                error: function(error) {
                    console.error("Error updating header:", error);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" Not Updated ")
                }
                });
                ...
                // ---------- End Item Level
                    ...
                    this._pBusyDialog.close();
                    if (Vendor_Return_H === ""){
                        this.getView().byId("Vendor_Return_H").setValueState(sap.ui.core.ValueState.Error)
                        
                    }else{
                        this.getView().byId("Vendor_Return_H").setValueState(sap.ui.core.ValueState.None)
                    }
            ...
            OnDeleteEntireDocument:function(){
                ...
                success: function(data) {
                    console.log("Header Updated:", data);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" Deleted Successfully")        
                    oModel05.refresh(true);
                    that.getView().byId("DeleteIndicId").setVisible(true); 
                    that.getView().byId("Final_Update_Button").setVisible(false); 
                    that.getView().byId("Final_DeleteEntireDocument_Button").setVisible(false); 
                ...
                error: function(error) {
                    console.error("Error updating header:", error);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" Not Deleted Successfully")
                }
                });
            ...
            OnUnDeleteEntireDocument:function(){
                ...
                success: function(data) {
                    console.log("Header Updated:", data);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" UnDeleted Successfully")        
                    oModel05.refresh(true);
                    that.getView().byId("DeleteIndicId").setVisible(false); 
                    that.getView().byId("Final_Update_Button").setVisible(true); 
                    that.getView().byId("Final_DeleteEntireDocument_Button").setVisible(true);
                ...
                error: function(error) {
                    console.error("Error updating header:", error);
                    that._pBusyDialog.close();
                    MessageToast.show(" "+Vendor_Return_H+" Not UnDeleted Successfully")
                }
                });
