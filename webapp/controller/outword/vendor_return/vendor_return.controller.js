sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.outword.vendor_return.vendor_return", {
            onInit: function () {

                this.getOwnerComponent().getModel("YY1_VENDOR_RETURN_OW_CDS").read("/YY1_VENDOR_RETURN_OW/$count", { /* Decalure Globally in the Create table Serial Number */
            ...
            On_Go_Button:function(){
                ...
                var oFilter2 = new sap.ui.model.Filter("GoodsMovementType", sap.ui.model.FilterOperator.EQ,"122");
                var oFilter3 = new sap.ui.model.Filter("GoodsMovementType", sap.ui.model.FilterOperator.EQ,"161");
                var oModel1 = this.getView().getModel("YY1_OW_RETURNABLE_CLN_ITEM_CDS"); // Replace with your actual OData model name
                var oFilters1 = [oFilter1, oFilter2, oFilter3];
                var that = this;
            ...
            // ====================================================================
                ...
                OnEditPage:function(oEvent){
                    var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			        oRouter.navTo("edit_vendor_return");
                },
                ...
                OnSubmit: function(oEvent){
                   ...
                   let Bin_Select_H = this.getView().byId("Bin_Select_H").getValue();
                ...
                for (var i = 0; i < Table_Length; i++) {
                    ...
                    if (oBindingContext) {
                        ...
                        itemData.push({
                            ...
                            oEntry.Bin_Challan_No= Bin_Select_H;
                            oEntry.Status= "";
                            oEntry.Status01= "";
                            ...
                            var oModel = this.getOwnerComponent().getModel("YY1_VENDOR_RETURN_OW_CDS");

                            var that = this;

                            oModel.create("/YY1_VENDOR_RETURN_OW", oEntry, {
                                success: function (oData, oResponse) {
                                    ...
                                    that.getOwnerComponent().getModel("YY1_VENDOR_RETURN_OW_CDS").read("/YY1_VENDOR_RETURN_OW/$count", { /* Decalure Globally in the Create table Serial Number */
                                    success: $.proxy(function (oEvent, oResponse) {
                                        let Count = Number(oResponse.body) + 1; // This should be a number, no need to use Number()
                                        let CountLen = Count.toString(); // Convert to string to get its length
                                        let AddData = "20005"; 
