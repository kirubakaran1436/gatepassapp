sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepass.controller.outword.returnable_challan.returnable_challan", {
            onInit: function () {

                this.getOwnerComponent().getModel("YY1_RETURN_CHALLAN_OW_CDS").read("/YY1_RETURN_CHALLAN_OW/$count", { /* Decalure Globally in the Create table Serial Number */
            ...
            select_i_o:function(){
                    ...
                    if (GatePass_Type_H == "" || GatePass_Type_H === "RGP" || GatePass_Type_H === "NRGP"){ // Both is equal to empty
                    ...
                    if(GatePass_Type_H !== "" || GatePass_Type_H === "RGP" || GatePass_Type_H === "NRGP"){ // po no & Invoice No - Both Not Empty
            ...
            On_Go_Button:function(){
                ...
                OnMatDocFragOpen:function(oEvent){
                    ...
                    if (!this._dialog_podochead) {
                        this._dialog_podochead = sap.ui.xmlfragment(this.getView().getId("MatDoc_dialog"), "gatepass.view.fragments.Material_Document_Head541", this);
                ...
                OnMatDocSelect : function (oEvent) {
                    ...
                    oModel1.read("/YY1_OW_Returnable_Cln_Item", {
                        ...
                        success: function(oData) {
                            ...
                            let ccode = aItems[0].Customer;
                            let cname = aItems[0].CustomerName;
                            ...
                            that.getView().byId("Customer_Code_H").setValue(ccode);
                            that.getView().byId("Customer_Name_H").setValue(cname);
                            that._pBusyDialog.close();
                ...
                OnEditPage:function(oEvent){
                    var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			        oRouter.navTo("edit_returnable_challan_ow");
                },
                ...
                OnSubmit: function(oEvent){
                   ...
                   let Customer_Code_H = this.getView().byId("Customer_Code_H").getValue();
                   let Customer_Name_H = this.getView().byId("Customer_Name_H").getValue();
                ...
                for (var i = 0; i < Table_Length; i++) {
                    ...
                    if (oBindingContext) {
                        ...
                        itemData.push({
                            ...
                            oEntry.Customer_Code= Customer_Code_H;
                            oEntry.Customer_Name= Customer_Name_H;
                            ...
                            oEntry.VehicleNumber= Vehicle_No;
                            oEntry.Posting_Date=this.CurrentDate;

                            oEntry.to_Item = itemData;
                            this.getView().setModel();
                            var oModel = this.getOwnerComponent().getModel("YY1_RETURN_CHALLAN_OW_CDS");

                            var that = this;

                            oModel.create("/YY1_RETURN_CHALLAN_OW", oEntry, {
